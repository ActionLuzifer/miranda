...
set PDBVer=miranda-im-pdb-v%Version%%PRVer%
set FileVer=miranda-im-v%Version%%PRVer%
set ContribVer=miranda-im-contrib-v%Version%%PRVer%
...
del /Q /F "%PDBVer%.7z"
7z.exe a -t7z -r -mx=9 "%PDBVer%.7z" %Temp%\pdba/*
rd /Q /S %Temp%\pdba
...
del /Q /F "%FileVer%.7z"
7z.exe a -t7z -r -mx=9 "%FileVer%.7z" %Temp%\miransi/*
rd /Q /S %Temp%\miransi
...
7z.exe a -t7z -r -mx=9 "%ContribVer%.7z" %Temp%\miransic/*
rd /Q /S %Temp%\miransic

set PDBVer=miranda-im-pdb-v%Version%%PRVer%x64
set FileVer=miranda-im-v%Version%%PRVer%x64
set ContribVer=miranda-im-contrib-v%Version%%PRVer%x64
...
del /Q /F "%PDBVer%.7z"
7z.exe a -t7z -r -mx=9 "%PDBVer%.7z" %Temp%\pdbx/*
rd /Q /S %Temp%\pdbx
...
del /Q /F "%FileVer%.7z"
7z.exe a -t7z -r -mx=9 "%FileVer%.7z" %Temp%\mirx64/*
rd /Q /S %Temp%\mirx64

rd /Q /S %Temp%\mx64c >nul
md %Temp%\mx64c
md %Temp%\mx64c\Plugins
md %Temp%\mx64c\Icons

copy Release\Icons\tabsrmm_icons.dll                       %Temp%\mx64c\Icons
copy Release\Icons\toolbar_icons.dll                       %Temp%\mx64c\Icons
copy "..\bin9\Release Unicode64\plugins\clist_modern.dll"            %Temp%\mx64c\Plugins
copy "..\bin9\Release Unicode64\plugins\clist_mw.dll"                %Temp%\mx64c\Plugins
copy "..\bin9\Release Unicode64\plugins\clist_nicer.dll"             %Temp%\mx64c\Plugins
copy "..\bin9\Release Unicode64\plugins\modernopt.dll"               %Temp%\mx64c\Plugins
copy "..\bin9\Release Unicode64\plugins\scriver.dll"                 %Temp%\mx64c\Plugins
copy "..\bin9\Release Unicode64\plugins\tabsrmm.dll"                 %Temp%\mx64c\Plugins

del /Q /F "%ContribVer%.7z"
7z.exe a -t7z -r -mx=9 "%ContribVer%.7z" %Temp%\mx64c/*
rd /Q /S %Temp%\mx64c

set PDBVer=miranda-im-pdb-v%Version%%PRVer%w
set FileVer=miranda-im-v%Version%%PRVer%w
set ContribVer=miranda-im-contrib-v%Version%%PRVer%w
...
del /Q /F "%PDBVer%.7z"
7z.exe a -t7z -r -mx=9 "%PDBVer%.7z" %Temp%\pdbw/*
rd /Q /S %Temp%\pdbw
...
del /Q /F "%FileVer%.7z"
7z.exe a -t7z -r -mx=9 "%FileVer%.7z" %Temp%\miransiw/*
...
copy Release\Icons\tabsrmm_icons.dll                       %Temp%\miransicw\Icons
...
del /Q /F "%ContribVer%.7z"
7z.exe a -t7z -r -mx=9 "%ContribVer%.7z" %Temp%\miransicw/*
